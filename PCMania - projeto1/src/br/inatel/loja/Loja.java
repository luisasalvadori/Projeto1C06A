...
public class Loja {
    ...
    public Loja() {
        ...
        comps1.adicionarHardware(hb11,0); // associação dos hardwares aos computador
        comps1.adicionarHardware(hb12,1);
        comps1.adicionarHardware(hb13,2);
        ...
        comps2.adicionarHardware(hb21,0);
        comps2.adicionarHardware(hb22,1);
        comps2.adicionarHardware(hb23,2);
        ...
        comps3.adicionarHardware(hb31,0);
        comps3.adicionarHardware(hb32,1);
        comps3.adicionarHardware(hb33,2);
